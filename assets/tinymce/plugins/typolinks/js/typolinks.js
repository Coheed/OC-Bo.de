...
var LinkDialog = {preInit: function () {
    var e;
    ...
    if (n == null) {
        t.getDoc().execCommand("unlink", !1, null), tinyMCEPopup.execCommand("mceInsertLink", !1, "#mce_temp_url#", {skip_undo: 1});
        var s = this;
        tinymce.each(t.dom.select("a"), function (r) {
            t.dom.getAttrib(r, "href") == "#mce_temp_url#" && (n = r, t.dom.setAttribs(n, {href: i, title: e.linktitle.value, target: e.target_list ? getSelectValue(e, "target_list") : null, rel: e.rel_list ? getSelectValue(e, "rel_list") : null, "class": e.class_list ? getSelectValue(e, "class_list") : null}), s.fixIssues(t, n, e))
        })
    } else t.dom.setAttribs(n, {href: i, title: e.linktitle.value, target: e.target_list ? getSelectValue(e, "target_list") : null, rel: e.rel_list ? getSelectValue(e, "rel_list") : null, "class": e.class_list ? getSelectValue(e, "class_list") : null}), this.fixIssues(t, n, e);
