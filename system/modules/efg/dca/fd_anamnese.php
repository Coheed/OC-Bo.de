...
// last created on 2014-02-21 21:30:00 by saving form "Anamnese"



/**
 * Table tl_formdata defined by form "Anamnese"
 */
...
(
	...
	<div class="fd_row field_betreuer"><div class="fd_label">Name des Betreuers: </div><div class="fd_value">%s </div></div>
			...
			/*
			'label_callback'          => array('tl_fd_anamnese','getRowLabel')
			*/
		),
 ...
 * @package    Efg
 */
class tl_fd_anamnese extends \Backend
{
